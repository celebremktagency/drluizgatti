      ...
      >
        ...
        {isMobile && mobileMenuOpen && (
          ...
          >
            ...
            <GoldButton onClick={() => { setMobileMenuOpen(false); setTimeout(scrollToForm, 100) }}>
              Agende sua Consulta
            </GoldButton>
          </div>
        )}
          ...
          <FadeIn delay={0.2} direction={isMobile ? 'up' : 'right'}>
            <div style={{ position: 'relative' }}>
              ...
              >
                <img
                  src="perfil.webp"
                  alt="Dr. Luiz Gatti - Especialista em Estética Corporal e Facial"
                  fetchpriority="high"
                  width="540"
                  height="720"
                  style={{
              ...
              <FadeIn key={num} delay={i * 0.1}>
                <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden' }}>
                  <img
                    ...
                    alt={`Resultado antes e depois de procedimento estético ${num} - Dr. Luiz Gatti`}
                    loading="lazy"
                    width="1038"
                    height="543"
                    style={{
